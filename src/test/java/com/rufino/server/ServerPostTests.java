...
public class ServerPostTests {
        ...
        void itShouldSaveItem() throws Exception {
                ...
                mockMvc.perform(post("/api/v1/item").contentType(MediaType.APPLICATION_JSON).content(my_obj.toString()))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.productId",
                                                Is.is("0f5de10a-b22e-444f-93ca-bf1cb416d028")))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.itemQuantity", Is.is(5)))
        ...
        void itShouldSaveItem_withId() throws Exception {
                ...
                my_obj.put("itemId", "5306dd68-3bfd-4d73-9d5d-255c3ef4f778");
                my_obj.put("orderId", "d0ba6751-90a2-4c50-9661-aecd8360188e");
                my_obj.put("productId", "0f5de10a-b22e-444f-93ca-bf1cb416d028");
                my_obj.put("itemName", "detergente liquido");
                my_obj.put("itemPrice", 1.99);
                my_obj.put("itemQuantity", 5);
                mockMvc.perform(post("/api/v1/item").contentType(MediaType.APPLICATION_JSON).content(my_obj.toString()))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.itemId",
                                                Is.is("5306dd68-3bfd-4d73-9d5d-255c3ef4f778")))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.orderId",
                                                Is.is("d0ba6751-90a2-4c50-9661-aecd8360188e")))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.productId",
                                                Is.is("0f5de10a-b22e-444f-93ca-bf1cb416d028")))
        ...
        void itShouldNotSaveItem() throws Exception {
                ...
                my_obj.put("itemQuantity", 5);
                mockMvc.perform(post("/api/v1/item").contentType(MediaType.APPLICATION_JSON).content(my_obj.toString()))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.itemName",
                ...
                mockMvc.perform(post("/api/v1/item").contentType(MediaType.APPLICATION_JSON).content(my_obj.toString()))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.itemName",
                                                Is.is("Value should not be empty")))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.itemPrice",
                                                Is.is("Value should not be empty")))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.orderId",
                                                Is.is("Invalid order ID format")))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.productId",
                                                Is.is("Invalid product ID format")))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.itemQuantity",
                                                Is.is("Value should not be empty")))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.message", Is.is("Not OK")))
                                .andExpect(status().isBadRequest()).andReturn();
