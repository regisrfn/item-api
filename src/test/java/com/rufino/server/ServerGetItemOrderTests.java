...
public class ServerGetItemOrderTests {
    ...
    void itShouldGetAllItems() throws Exception {
        ...
        MvcResult result = mockMvc
                .perform(get("/api/v1/item/order/d0ba6751-90a2-4c50-9661-aecd8360188e")
        ...
        List<Item> itemList = Arrays.asList(objectMapper.readValue(result.getResponse().getContentAsString(), Item[].class));
